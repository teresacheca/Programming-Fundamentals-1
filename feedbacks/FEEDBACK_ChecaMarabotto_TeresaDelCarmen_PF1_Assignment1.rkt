...
; FEEDBACK: Great! But global constants must be capitalized.
; For instance, FIRST-WEEK is correct.
...
; FEEDBACK: Great! Same as what I said about E1 (Exercise 1). NUM-WEEKS is better.
...
; FEEDBACK: Great! You do not need to define functions for this exercise.
; But it is totally fine if you do that.
...
; FEEDBACK: Same as what I said about E1. Also, the final expression must be
; STANDARD-BETTER? (note the question mark).
...
; FEEDBACK: Great! But function argument names must follow the keba case naming convention. For
; example, input-name is better than InputName.
