...
; FEEDBACK: Great! Data types must be in camel case. So, CM is the correct name.
; Also, it is better if you choose better names such as Centimeter.
...
; FEEDBACK: Great! Same as E1 (Exercise 1).
...
; FEEDBACK: You do not need to define any data types for this exercise.
; The signature is: Number Number Number Number -> Number.
...
; FEEDBACK: Great! You do not need to define any data type for this exercise.
; Data type names must be in camel case. For instance, Area is correct.
; The signature is: Number Number -> Number.
...
; FEEDBACK: The signature is: Number -> Boolean, and you do not need to
; define any data types here.
...
; FEEDBACK: The name must be in camel case (ChfPrice).
...
; FEEDBACK: n_rolls must be in camel case (NRoll), and it is an interval.
; See the slides to find put how intervals are defined.
...
; FEEDBACK: NeoLatin and English are the correct names for the
; data types defined by you. Also, the interpretation parts are missing.
; The signature is: NeoLatin -> English.
; Wrong template.
