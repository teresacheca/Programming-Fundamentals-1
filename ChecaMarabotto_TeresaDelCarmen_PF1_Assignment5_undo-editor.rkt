...
; Ecenarios: 1. presionas una tecla que cambia 2. presionas escape
;3. presionas una tecla que
; no cambia por lo que devuelves el mismo estado
(define (undo-edit e key)
  (cond
    ...
    [else (make-undoEditor (edit (undoEditor-actual e) key) (list (undoEditor-actual e) (undoEditor-previous e)))]
))


;;Examples
(check-expect (undo-edit UE1 "escape") (make-undoEditor (make-editor "hello" "world") (rest l1)))
(check-expect (undo-edit UE1 " ")  (make-undoEditor (edit (undoEditor-actual UE1) " ") (list (undoEditor-actual UE1) (undoEditor-previous UE1))))
...
(check-expect (undo-edit UE4 "X")  (make-undoEditor (edit (undoEditor-actual UE4) "X") (list (undoEditor-actual UE4) (undoEditor-previous UE4))))
